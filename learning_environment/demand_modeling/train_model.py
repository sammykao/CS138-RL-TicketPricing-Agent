...
def main():
    ...
    # Use 2000h max time and reference price around 2000h
    df = extract_sales_data(
        args.db_path,
        max_time_hours=2000.0,
        reference_target_hours=2000.0,
        reference_window_hours=50.0  # Very narrow window: 1975-2025h (very close to 2000h)
    )
